...
var (
	...
	GITOLITE_USER_CONF_DIR_PATH = path.Join(GITOLITE_CONF_FILE_PATH, "gitolite.d", "user")
	GITOLITE_REPOSITORY_CONF_DIR_PATH = path.Join(GITOLITE_USER_CONF_DIR_PATH, "gitolite.d", "repository")
